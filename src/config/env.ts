...
const REFRESH_TOKEN_EXPIRE_TIME = process.env.REFRESH_TOKEN_EXPIRE_TIME as string;
const ACCESS_TOKEN_EXPIRE_TIME = process.env.ACCESS_TOKEN_EXPIRE_TIME as string;
const JWT_SECRET_KEY = process.env.JWT_SECRET_KEY as string;
const AUTH_COOKIE_NAME = process.env.AUTH_COOKIE_NAME as string;
const AUTH_COOKIE_EXPIRE_TIME = Number(process.env.AUTH_COOKIE_EXPIRE_TIME)
